...
function drawUI()
    while true do
        if drawUItoggle == true then
            ...
            if list == 3 then
                for i1=1, #vanilla_music_overworld do
                    if i1 == playing and playinglist == list then
                        sc(c.lime)
                    else
                        sc(c.white)
                    end
                    wd(vanilla_music_overworld[i1])
                end
            end
            if list == 4 then
                for i1=1, #vanilla_music_nether do
                    if i1 == playing and playinglist == list then
                        sc(c.lime)
                    else
                        sc(c.white)
                    end
                    wd(vanilla_music_nether[i1])
                end
            end
            if list == 5 then
...
function clickListener()
    while true do
        ...
        if y > 2 then
            ...
            if list == 3 and vanilla_music_overworld[selected] ~= nil then
                speaker.stop()
                os.sleep(0.25)
                speaker.playSound("minecraft:music.overworld."..vanilla_music_overworld[selected])
                playing = selected
                playinglist = 3
            end

            if list == 4 and vanilla_music_nether[selected] ~= nil then
                speaker.stop()
                os.sleep(0.25)
                speaker.playSound("minecraft:music.nether."..vanilla_music_nether[selected])
                playing = selected
                playinglist = 4
            end

            if list == 5 and modded_1_list[selected] ~= nil then
                speaker.stop()
                os.sleep(0.25)
