...
local transceiver = "t = peripheral.find('transceiver')"
...
local transceiver_stat = ""
if not peripheral.find("transceiver") then
    transceiver_stat = " (Missing)"
end

local clear = "term.clear() term.setCursorPos(1,1) print('a = basic "..basic_stat.."\\nb = crystal "..crystal_stat.."\\nc = advanced "..advanced_stat.."\\nt = transceiver "..transceiver_stat.."')"
...
--os.queueEvent("key", keys.enter, false)
--
--for i1=1, #transceiver do
--    local char = transceiver:sub(i1,i1)
--    os.queueEvent("char", char)
--end
--os.queueEvent("key", keys.enter, false)
--
...
os.queueEvent("paste", basic.." "..crystal.." "..advanced.." "..transceiver.." "..clear)
os.queueEvent("key", keys.enter, false)
